// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DecryptConfig.cs" company="CGI">
...
{
    public class DecryptConfig : ConsoleCommand
    {
        public DecryptConfig()
        {
            IsCommand("decrypt-config", "Decrypt the configuration file");

            Options = new OptionSet
            {
                { "f|file=", "Configuration file", f => FileName = f }
            };
        }
        ...
        public override int Run(string[] remainingArguments)
        {
            ...
            if (reflexSection != null && reflexSection.SectionInformation.IsProtected)
                reflexSection.SectionInformation.UnprotectSection();
            ...
            if (smtpSection != null && smtpSection.SectionInformation.IsProtected)
                smtpSection.SectionInformation.UnprotectSection();
